...
#define MODE_RAINBOW 0xFE
#define MODE_HOT 0xFD
#define MODE_COOL 0xFC
#define MODE_FOREST 0xFB
#define MODE_OCEAN 0xFA
#define MODE_SUNSET 0xF9
...
const char *VALUE_MODE_RAINBOW = "rainbow";
const char *VALUE_MODE_HOT = "hot";
const char *VALUE_MODE_COOL = "cool";
const char *VALUE_MODE_FOREST = "forest";
const char *VALUE_MODE_OCEAN = "ocean";
const char *VALUE_MODE_SUNSET = "sunset";
...
char usage[] =
	...
	"		       -level <valid_brightness>\n"
	"Usage [GAMING MODE]:\n"
	"msiledenabler -mode gaming -color1 <valid_color> -level <valid_brightness>\n\n"
	"Usage [EXPERIMENTAL MODES] (May not work on GT70):\n"
	"Modes: breathing, wave, dualcolor\n"
	"msiledenabler -mode <mode> -level <valid_brightness>\n\n"
	"Usage [PRESETS]:\n"
	"msiledenabler -mode <preset> -level <valid_brightness>\n"
	"Valid Presets: [rainbow|hot|cool|forest|ocean|sunset]\n\n"
	"Valid brightness levels: [0,1,2,3] (0=Darker, 3=Brighter/Whiter)\n"
